...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="/">
      ...
      <tr>
         <td colspan="3"><div>
            <table>
               <xsl:for-each select="/Data/Results/Sample">
                     ...
                     <td>
                        <a>
                           <xsl:attribute name="href">
                              <xsl:if test="ID='sampleId001'">Sample-sampleId001.html</xsl:if>
                              <xsl:if test="ID='sampleId002'">Sample-sampleId002.html</xsl:if>
                           </xsl:attribute>
