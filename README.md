...
This downloader can fixes over 2060 entries during export:
...
* 60 entries with missing rule keywords. (Quick Kill range, Cloudburst spirit keyword, Blistered Soul type etc.)
