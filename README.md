...
This downloader can fixes over 2070 entries during export:

* 551 powers classified as "Theme Power" or "Multiclass" (actually Spellscarred), corrected.
* 318 entries with inconsistency in wordings. (Winged Armor type, Xenda-Dran Array tier, Racial power without type etc.)
...
* 66 entries with missing rule keywords. (Quick Kill range, Cloudburst spirit keyword, Blistered Soul type etc.)
...
* 18 typos. (Cambion Stalwart "bit points", Primal Grove "grp", Rubble Topple "Singe", Essential hybrid sourcebook etc.)
