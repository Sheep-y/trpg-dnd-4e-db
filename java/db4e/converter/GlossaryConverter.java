   ...
   @Override protected void correctEntry () {
      ...
      switch ( entry.getId() ) {
         case "glossary03": // Ability Scores
            entry.setName( "Ability Scores" ).setFields( "Rules", "Rules Other", null ).setContent( unzip(
         ...
         case "glossary070": // Implement
            entry.setName( "Implements" ).setFields( "Rules", "Rules Other", null ).setContent( unzip(
         ...
         case "glossary0453": // Item Set
            entry.setName( "Item Set" ).setFields( "Rules", "Rules Other", null ).setContent( unzip(
         ...
         case "glossary0677": // Totem
            entry.setName( "Totem" ).setFields( "Implement", "Implement Group", null ).setContent( unzip(
         ...
         case "glossary0678": // Wand
            entry.setName( "Wand" ).setFields( "Implement", "Implement Group", null ).setContent( unzip(
